...
CREATE TABLE `estados_video` (
  ...
  `oculto` int DEFAULT NULL,
  `privado` int DEFAULT NULL,
  KEY `id_estado_publico` (`publico`) /*!80000 INVISIBLE */,
  KEY `id_estado_oculto` (`oculto`) /*!80000 INVISIBLE */,
  KEY `id_estado_privado` (`privado`) /*!80000 INVISIBLE */
