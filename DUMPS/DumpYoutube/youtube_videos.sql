...
CREATE TABLE `videos` (
  ...
  PRIMARY KEY (`id_videos`,`etiquetas_id_etiquetas`,`usuarios_id`),
  ...
  CONSTRAINT `fk_videos_usuarios1` FOREIGN KEY (`usuarios_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
