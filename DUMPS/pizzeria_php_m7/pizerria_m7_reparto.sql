...
CREATE TABLE `reparto` (
  ...
  `nombre_repartidor` varchar(15) NOT NULL,
  `hora_pedido` datetime NOT NULL,
  PRIMARY KEY (`id_reparto`),
  CONSTRAINT `fk_repartidor_reparto` FOREIGN KEY (`id_reparto`) REFERENCES `trabajadores` (`id_trabajadores`) ON DELETE CASCADE ON UPDATE CASCADE
