...
CREATE TABLE `tiendas` (
  ...
  KEY `id_pedidos_tienda` (`id_tiendas`) /*!80000 INVISIBLE */,
  CONSTRAINT `fk_trabajador_tienda` FOREIGN KEY (`id_tiendas`) REFERENCES `trabajadores` (`id_trabajadores`) ON DELETE CASCADE ON UPDATE CASCADE
