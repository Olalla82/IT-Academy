...
CREATE TABLE `registro_pagos` (
  `id_registro_pagos` int NOT NULL AUTO_INCREMENT,
  `fecha_registro_pagos` datetime NOT NULL,
  `precio_total_pagos` int NOT NULL,
  PRIMARY KEY (`id_registro_pagos`),
  KEY `id_pagos_tarjeta` (`id_registro_pagos`)
