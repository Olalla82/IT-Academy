...
<body style="background-image:url('https://images-na.ssl-images-amazon.com/images/I/91BZBH6qkcL._AC_SL1500_.jpg'); background-size: cover;">
    ...
    <div class="container">
        ...
        <div class="row d-flex justify-content-between">
                ...
                <div class="justify-content-center m-4">
                    <button class="btn btn-light p-3" style="border: 6px solid red; border-radius: 15px;">
                      <a class="nav-link active text-danger font-weight-bold" href="{{route('games.index'), $player->nombre}}" style="font-size: 30px;">JUGAR PARTIDA</a>
                    </button>  
                </div>
        ...
        <div class="row d-flex flex-column">
            <div class="d-flex justify-content-center"><h2 class="text-light display-5 font-weight-bold"  style="text-shadow: 3px 3px 15px black;">BIENVENIDOS A NUESTRO JUEGO DE DADOS</h2></div><br>  
            <div class="d-flex justify-content-center"><h2  class="text-light display-5 font-weight-bold" style="text-shadow: 3px 3px 15px black;" >¡DISFRUTA LA PARTIDA!</h2></div></div>
        </div>
    </div>
