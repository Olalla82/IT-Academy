...
<body class="bg-secondary">
    ...
    <div class="container"><br>
        <h1 class="display-2 text-light">AÑADIR DATOS DEL TRABAJADOR</h1><br>
        
        <form class="form" action="{{route('empleado.envio')}}" method="post">
            ...
            <input type="mail" name="email" value="{{old('email')}}" class="form-control" placeholder="Email"><br>
                    @error('email')
                        <br>
                        <small>*{{$message}}</small>
                        <br>                
            ...
            <select class="form-select text-secondary" name="cargo" value="{{old('cargo')}}" id="">
            ...
            <div class="d-grid gap-2">
                <button class="btn btn-info text-dark" type="submit"><h2 class="display-6">AÑADIR TRABAJADOR</h2></button>
            </div>
