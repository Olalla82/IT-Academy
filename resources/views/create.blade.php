...
<body style="background-image:url('https://s1.eestatic.com/2016/07/09/elandroidelibre/el_androide_libre_138749861_180142680_1024x576.jpg'); background-size: cover;">
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            ...
            <form class="" action="{{route('player.store')}}" method="post">
        @csrf
                <div class="row justify-content-center">
                    <label for="" class="display-4 font-weight-bold text-light" style="text-shadow: 5px 5px 18px black;">
                        NOMBRE DEL JUGADOR
                    </label>
                </div>
                <br><br>
                <div class="row justify-content-center m-5">
                    ...
                    <input class="col-8 p-3" style="border-radius: 10px;"type="text" name="nombre">
                </div>
                <br><br>
                <div class="row justify-content-center m-5">
