...
<body class="container-fluid" style="background-size:cover; background-image:url('https://www.blauverdhotels.com//media/hoteles/hostal-estrella/00.hostal-estrella-1400px.jpg');">
  ...
  @csrf
        <fieldset>
          <legend><h1 class=" text-light display-3 font-weight-bold" style="text-shadow: 3px 3px 15px black;">BOOKING HOTELES</h1></legend>
          
          <div class="mb-3 col-12">
            <label class="form-label text-light display-6" style="text-shadow: 5px 5px 15px black;">SELECCIONA EL HOTEL</label>
            <select class="form-select" name="nombre_hotel" value="{{old('nombre_hotel')}}" selected>
          ...
          <div class="mb-3 col-md-1">
            <label class="form-label text-light display-6" style="text-shadow: 10px 10px 15px black;">HABITACIONES</label>
              <select class="form-select" name="numero_habit" value="{{old('numero_habit')}}">
                <option>1</option>
                <option>2</option>
                <option>3</option>
                <option>4</option>
          ...
          <div class="col-md-1">
              ...
              <label class="form-label text-light display-6" style="text-shadow: 10px 10px 15px black;">NOCHES</label>
                <select class="form-select" name="numero_noches" value="{{old('numero_noches')}}">
                  <option>1</option>
                  <option>2</option>
                  <option>3</option>
                  <option>4</option>
          ...
          <div class="d-flex justify-content-between">
              <div>
                <label for="" class="text-light display-6" style="text-shadow: 10px 10px 15px black;">FECHA ENTRADA</label><br><br>
              ...
              <br><br>
              <div>
                <label for="" class="text-light display-6" style="text-shadow: 10px 10px 10px black;">FECHA SALIDA</label><br><br>
          ...
          <div class="col-md-1">
            <label class="form-label text-light display-6" style="text-shadow: 10px 10px 15px black;">PERSONAS</label>
              <select class="form-select" name="numero_personas" value="{{old('numero_personas')}}">
                <option>1</option>
                <option>2</option>
                <option>3</option>
                <option>4</option>
